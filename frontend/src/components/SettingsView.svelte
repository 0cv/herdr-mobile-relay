<script lang="ts">
  ...
  const MANAGED_UPDATE_COMMAND = 'HERDR_MOBILE_RELAY_NO_AUTO_SETUP=1 herdr plugin install 0cv/herdr-mobile-relay-dev --yes && herdr plugin action invoke install-service --plugin herdr-mobile-relay.events';
